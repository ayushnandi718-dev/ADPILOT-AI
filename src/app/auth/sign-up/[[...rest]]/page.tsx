    ...
    <div className="min-h-screen flex items-center justify-center bg-[#09090B] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#FAFAFA] mb-2">Create your account</h1>
          <p className="text-[#9CA3AF]">Start optimizing your campaigns with AI</p>
        </div>
        ...
        <div className="glass rounded-xl p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-[#9CA3AF] mb-1.5">Name (optional)</label>
              <input
                type="text"
                value={name}
            ...
            <p className="text-center text-sm text-[#6B7280]">
              ...
              <Link href="/auth/sign-in" className="text-[#7C3AED] hover:text-[#6D28D9]">
                Sign in
              </Link>
            </p>
          </form>
